...
import { listCommand, statusCommand } from '../commands/status.js';
...
program
  ...
  .option(
    '--ai <agent>',
    t(
      'AI assistant type: claude, cursor, copilot, gemini, windsurf, qwen, opencode, codex, codebuddy, qoder',
      'AI 助手类型: claude, cursor, copilot, gemini, windsurf, qwen, opencode, codex, codebuddy, qoder'
    ),
    'cursor'
  )
...
program
  .command('update')
  .description(t('Refresh agent instructions and templates', '刷新 agent 指令和模板'))
