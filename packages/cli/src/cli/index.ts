...
program
  ...
  .option(
    '--ai <agent>',
    t(
      'AI assistant type: claude, cursor, gemini, windsurf, qwen, opencode, codex, codebuddy, qoder',
      'AI 助手类型: claude, cursor, gemini, windsurf, qwen, opencode, codex, codebuddy, qoder'
    ),
    'cursor'
  )
