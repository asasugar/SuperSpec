...
| 命令 | 说明 |
|------|------|
| [`/ss-create`](/zh/slash-commands/ss-create) | 创建变更 + 生成 proposal |
| [`/ss-tasks`](/zh/slash-commands/ss-tasks) | 从 proposal 生成任务清单 |
| [`/ss-apply`](/zh/slash-commands/ss-apply) | 逐个执行任务 |
| [`/ss-resume`](/zh/slash-commands/ss-resume) | 恢复 spec 上下文 |
| [`/ss-archive`](/zh/slash-commands/ss-archive) | 归档已完成的变更 |

### 质量与发现命令

| 命令 | 模式 | 说明 |
|------|------|------|
| [`/ss-clarify`](/zh/slash-commands/ss-clarify) | 通用 | 澄清歧义、记录决策 |
| [`/ss-checklist`](/zh/slash-commands/ss-checklist) | 增强 | apply 前的质量门 |
| [`/ss-lint`](/zh/slash-commands/ss-lint) | 通用 | 检查 artifact 大小 |
| [`/ss-validate`](/zh/slash-commands/ss-validate) | 增强 | 交叉引用一致性检查 |
